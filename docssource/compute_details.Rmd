...
Standard errors are slightly different, but that is due to the fact that regression uses OLS and path analysis uses ML. We also get the same $R^2$ and comparable p-value for the $R^2$, which introduces us to the next topic.



# $R^2$ and their tests and confidence intervals
