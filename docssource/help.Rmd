...
Continuous variables, by default, are not changed in scale (`r opt("none")`), but one can center them (`r opt("centered")`), standardize them (`r opt("z-scores")`), log-transform (`r opt("Log")`). Centering may be useful when interactions are involved in the model.
